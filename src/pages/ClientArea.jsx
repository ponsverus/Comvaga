                ...
                <div className="flex items-start gap-3 border-b border-gray-800 px-4 py-3 sm:px-6">
                  ...
                  <div className="min-w-0 flex-1">
                    <input
                      ...
                      className="w-full bg-transparent px-0 py-2 text-[14px] text-white uppercase max-w-[calc(100vw-13.75rem)] truncate pr-4 sm:max-w-none sm:pr-0 placeholder-gray-600 outline-none focus:text-white"
