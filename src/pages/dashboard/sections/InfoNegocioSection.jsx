    ...
    <div className="-m-6">
      ...
      <div className="border-b border-gray-800 px-4 py-4 sm:px-6">
        ...
        {galeriaItems.length > 0 ? (
          <>
            <div className="columns-2 gap-0.06 lg:columns-3">
              {galeriaItems.map((item) => (
                <div key={item.id || item.path} className="relative mb-0.06 w-full break-inside-avoid overflow-hidden rounded-custom border border-gray-800 bg-dark-200">
